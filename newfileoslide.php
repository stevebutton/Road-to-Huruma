...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<script type="text/javascript" src="oslider/jquery-1.4.2.min.js"></script>
...
<script type='text/javascript' src='timemap.2.0/lib/jquery.content-panel-switcher.js'></script>  
    ...
    div#mapcontainer_commented{ height: 300px; }
    div.infodescription { height: 130px; }
    div#mapcontainer {width: auto; height: auto; }
    div#timebox { height: auto; bottom: 0px;}
    div#mapcontainer {position: absolute; left: 0px; right: 0px; bottom: 20px; top: 434px;}
    </style>
<script type='text/javascript'>
...
<!--End mc_embed_signup-->
<p>Suspendisse semper, magna eu blandit pellentesque, elit purus tristique orci, sit amet congue lectus purus ut nisi. Curabitur mollis purus sed purus commodo vitae malesuada sem viverra? Nunc mattis cursus elit, eget accumsan diam semper a. Mauris imperdiet fringilla ipsum, sed ultrices nunc auctor vel. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer porta pellentesque vulputate. Mauris sed purus ac lorem sodales ullamcorper. Phasellus velit urna, sagittis vitae scelerisque a, adipiscing sed mi? Suspendisse eget elit diam.
</p>
</div>
</div>
...
<div class="block2 mid margin_auto">
  ...
  <div class="contheader2">
    ...
    <div class="nav_buttons"> 
      ...
      <a id="gasc" class="switcher set2">Same Heart</a>
            <a id="sextant" class="switcher set2">Content That Moves</a> 
      <a id="ginger" class="switcher set2">Media Voices</a> 
      <a id="sublab" class="switcher set2">Another</a> 
  ...
  <p>Suspendisse semper, magna eu blandit pellentesque, elit purus tristique orci, sit amet congue lectus purus ut nisi. Curabitur mollis purus sed purus commodo vitae malesuada sem viverra? Nunc mattis cursus elit, eget accumsan diam semper a. Mauris imperdiet fringilla ipsum, sed ultrices nunc auctor vel. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer porta pellentesque vulputate. Mauris sed purus ac lorem sodales ullamcorper. Phasellus velit urna, sagittis vitae scelerisque a, adipiscing sed mi? Suspendisse eget elit diam. Nullam lobortis turpis dolor, vel euismod enim. Etiam arcu libero, porta at dignissim nec; ullamcorper semper dui. Curabitur ac lacus nisi, eget tincidunt orci. Vivamus orci diam, viverra et pellentesque quis, luctus eu massa. Fusce aliquet nibh nec elit dapibus adipiscing. Aliquam a lacus non massa posuere tincidunt vitae id nisl.
   ...
   <div id="circles">
		<a href="index.html"><img src="oslider/images/slider/road.png" width="600" height="300" rel="circles_road" /></a>
		<a href="index.html"><img src="oslider/images/slider/bed.jpg" width="600" height="300" rel="circles_bed" /></a>
		<a href="index.html"><img src="oslider/images/slider/chair.jpg" width="600" height="300" rel="circles_chair" /></a>
...
<div class="block3 mid margin_auto">
  <div class="contheader3">
    ...
    <h2>asdasdasdasd</h2>
    <strong>sadasdsadasdsa</strong>
Lorem ipsum ea cum congue bonorum, pri no natum clita. His ne vide omnis forensibus. Eum cetero imperdiet et. Id mutat mazim quo, recusabo consequat scribentur te pro, nam laudem eripuit at.  </div>
