...
class WPSimileTimelineAdmin{
	...
	function saveAdminOptions($postdata){
		...
		if(function_exists('add_settings_error')){
			add_settings_error('stl_timeline_options', 'settings_updated', __('Settings saved.'), 'updated');
		}
	}
	 ...
	 */
	function outputCategoriesTable($term_type='category') {
		$row = '<tr>
	...
	?>
	    ...
	    <ul id="stl-timeline-options-tabs">
			...
			<form name="stl_options" method="post" action="<?php echo wp_nonce_url('options-general.php?page=timeline.php&updated=true', STL_TIMELINE_NONCE_NAME); ?>"><?php /*  */ ?>
	...
	******************************************************
	-->
				...
				<h3><?php _e('Timeline Categories', 'stl_timeline'); ?></h3>
					<p><small><?php printf(__('Select the categories the Timeline should display.','stl_timeline') ); ?></small></p>
					<?php WPSimileTimelineAdmin::outputCategoriesTable('category'); ?>
					<p class="submit"><input type="submit" class="button-primary" name="Submit" value="<?php _e('Update Options', 'stl_timeline') ?>" /></p>
				</fieldset>
				<fieldset class="options">
				<h3><?php _e('Timeline Link Categories', 'stl_timeline'); ?></h3>
					...
					<?php WPSimileTimelineAdmin::outputCategoriesTable('link_category'); ?>
					<p class="submit"><input type="submit" class="button-primary" name="Submit" value="<?php _e('Update Options', 'stl_timeline') ?>" /></p>
				</fieldset>
				</div>	
	<!--
			...
			<tr><td class="nofoot bandoptions">
				...
				******************************************************
				...
				<tr>
					...
					<input type="hidden" value="<?php echo $hotzone->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][$hotzone->id][id]"; ?>" />
					
					<label for="<?php echo "stl_timelinehotzone_name_".$band->id.$hotzone->id; ?>"><?php _e('Name', 'stl_timeline'); ?></label>
					<input type="text" value="<?php echo $hotzone->name; ?>" id="<?php echo "stl_timelinehotzone_name_".$band->id.$hotzone->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][$hotzone->id][name]"; ?>" />
					<br />
					<label for="<?php echo "stl_timelinehotzone_unit_".$band->id.$hotzone->id; ?>"><?php _e('Resolution', 'stl_timeline'); ?></label>
					<?php echo WPSimileTimelineAdmin::outputUnitSelectElement("stl_timeline[bands][$band->id][hotzones][$hotzone->id][unit]", "stl_timelinehotzone_unit_".$band->id.$hotzone->id, $hotzone->unit); ?>
					<br />
					<label><?php _e('Start Date', 'stl_timeline'); ?></label>
					<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][hotzones][$hotzone->id][start_date]", $hotzone->start_date, false); ?>
					<br />
					<label><?php _e('End Date', 'stl_timeline'); ?></label>
					<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][hotzones][$hotzone->id][end_date]", $hotzone->end_date, false); ?>
					<br />
					<label for="<?php echo "stl_timelinehotzone_magnify_".$band->id.$hotzone->id; ?>"><?php _e('Magnify', 'stl_timeline'); ?></label>
					<input type="text" size="3" value="<?php echo $hotzone->magnify; ?>" id="<?php echo "stl_timelinehotzone_magnify_".$band->id.$hotzone->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][$hotzone->id][magnify]"; ?>" />
					<br />
					<label for="<?php echo "stl_timelinehotzone_multiple_".$band->id.$hotzone->id; ?>"><?php _e('Multiple', 'stl_timeline'); ?></label>
					<input type="text" size="3" value="<?php echo $hotzone->multiple; ?>" id="<?php echo "stl_timelinehotzone_multiple_".$band->id.$hotzone->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][$hotzone->id][multiple]"; ?>" />
				...
				<tr class="stl-newentry">
					<td>
					<h4><?php _e('New Hotzone', 'stl_timeline'); ?></h4>
					<div class="suboptions">
					<input type="hidden" value="<?php echo $band->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][0][stl_timeline_band_id]"; ?>" />
					<label for="<?php echo "stl_timelinehotzone_name_".$band->id."0"; ?>"><?php _e('Name', 'stl_timeline'); ?></label>
					<input type="text" value="" id="<?php echo "stl_timelinehotzone_name_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][0][name]"; ?>" />
					<br />
					<label for="<?php echo "stl_timelinehotzone_unit_".$band->id."0"; ?>"><?php _e('Resolution', 'stl_timeline'); ?></label>
					<?php echo WPSimileTimelineAdmin::outputUnitSelectElement("stl_timeline[bands][$band->id][hotzones][0][unit]", "stl_timelinehotzone_unit_".$band->id."0", 3); ?>
					
					<br />
					<label><?php _e('Start Date', 'stl_timeline'); ?></label>
					<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][hotzones][0][start_date]", 0, false); ?>
					<br />
					<label><?php _e('End Date', 'stl_timeline'); ?></label>
					<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][hotzones][0][end_date]", 0, false); ?>
					<br />
					<label for="<?php echo "stl_timelinehotzone_magnify_".$band->id."0"; ?>"><?php _e('Magnify', 'stl_timeline'); ?></label>
					<input type="text" size="3" value="1" id="<?php echo "stl_timelinehotzone_magnify_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][0][magnify]"; ?>" />
					<br />
					<label for="<?php echo "stl_timelinehotzone_multiple_".$band->id."0"; ?>"><?php _e('Multiple', 'stl_timeline'); ?></label>
					<input type="text" size="3" value="1" id="<?php echo "stl_timelinehotzone_multiple_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][hotzones][0][multiple]"; ?>" />
					<small>(<?php _e('show every n-th unit marker', 'stl_timeline'); ?></small>
					</div>
				...
				******************************************************
				...
				<tr>
					...
					<div class="suboptions">
					<input type="hidden" value="<?php echo $decorator->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][id]"; ?>" />
					<input type="hidden" value="<?php echo $band->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][stl_timeline_band_id]"; ?>" />
					
						<div>
							<label for="<?php echo "stl_timelinedecorator_name_".$band->id.$decorator->id; ?>"><?php _e('Name', 'stl_timeline'); ?></label>
							<input type="text" value="<?php echo $decorator->name; ?>" id="<?php echo "stl_timelinedecorator_name_".$band->id.$decorator->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][name]"; ?>" />
						</div>
						<div>
							<label><?php _e('Type', 'stl_timeline'); ?></label>
							<?php WPSimileTimelineAdmin::outputDecoratorTypeSelect("stl_timeline[bands][$band->id][decorators][$decorator->id][type]", $decorator->type); ?>
						</div>
						<div>
							<label><?php _e('Start Date', 'stl_timeline'); ?></label>
							<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][decorators][$decorator->id][start_date]", $decorator->start_date, false); ?>
						</div>
						<div class="stl_timeline_decorator_optional"<?php if($decorator->type==0) echo ' style="display:none;"'; ?>>
							<label><?php _e('End Date', 'stl_timeline'); ?></label>
							<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][decorators][$decorator->id][end_date]", $decorator->end_date, false); ?>
						</div>
						<div class="stl_timeline_decorator_optional"<?php if($decorator->type==0) echo ' style="display:none;"'; ?>>
							<label for="<?php echo "stl_timelinedecorator_startlabel_".$band->id.$decorator->id; ?>"><?php _e('Start Label', 'stl_timeline'); ?></label>
							<input type="text" value="<?php echo $decorator->start_label; ?>" id="<?php echo "stl_timelinedecorator_startlabel_".$band->id.$decorator->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][start_label]"; ?>" />
						</div>
						<div class="stl_timeline_decorator_optional"<?php if($decorator->type==0) echo ' style="display:none;"'; ?>>
							<label for="<?php echo "stl_timelinedecorator_endlabel_".$band->id.$decorator->id; ?>"><?php _e('End Label', 'stl_timeline'); ?></label>
							<input type="text" value="<?php echo $decorator->end_label; ?>" id="<?php echo "stl_timelinedecorator_endlabel_".$band->id.$decorator->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][end_label]"; ?>" />
						</div>
						<div>
							<label for="<?php echo "stl_timelinedecorator_cssclass_".$band->id.$decorator->id; ?>"><?php _e('CSS class', 'stl_timeline'); ?></label>
							<input type="text" value="<?php echo $decorator->css_class; ?>" id="<?php echo "stl_timelinedecorator_cssclass_".$band->id.$decorator->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][css_class]"; ?>" />
						</div>
						<div>
							<label><?php _e('Color', 'stl_timeline'); ?></label>
							<?php echo WPSimileTimelineAdmin::buildColorpickInput("stl_timeline[bands][$band->id][decorators][$decorator->id][color]",$band->id,'stl_band'.$band->id.$decorator->id.'_color',$decorator->color); ?>
						</div>
						<div>
							<label for="<?php echo "stl_timelinedecorator_opacity_".$band->id.$decorator->id; ?>"><?php _e('Opacity', 'stl_timeline'); ?></label>
							<input type="text" size="3" value="<?php echo $decorator->opacity; ?>" id="<?php echo "stl_timelinedecorator_opacity_".$band->id.$decorator->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][$decorator->id][opacity]"; ?>" />
						</div>
					</div>
				...
				<tr class="stl-newentry">
					...
					<div class="suboptions">
					<input type="hidden" value="<?php echo $band->id; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][0][stl_timeline_band_id]"; ?>" />
						<div>
							<label for="<?php echo "stl_timelinedecorator_name_".$band->id."0"; ?>"><?php _e('Name', 'stl_timeline'); ?></label>
							<input type="text" value="" id="<?php echo "stl_timelinedecorator_name_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][0][name]"; ?>" />
						</div>
						<div>
							<label><?php _e('Type', 'stl_timeline'); ?></label>
							<?php WPSimileTimelineAdmin::outputDecoratorTypeSelect("stl_timeline[bands][$band->id][decorators][0][type]", 1); ?>
						</div>
						<div>
							<label><?php _e('Start Date', 'stl_timeline'); ?></label>
							<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][decorators][0][start_date]", 0, false); ?>
						</div>
						<div class="stl_timeline_decorator_optional">
							<label><?php _e('End Date', 'stl_timeline'); ?></label>
							<?php WPSimileTimelineAdmin::outputDatepicker("stl_timeline[bands][$band->id][decorators][0][end_date]", 0, false); ?>
						</div>
						<div class="stl_timeline_decorator_optional">
							<label for="<?php echo "stl_timelinedecorator_startlabel_".$band->id."0"; ?>"><?php _e('Start Label', 'stl_timeline'); ?></label>
							<input type="text" value="" id="<?php echo "stl_timelinedecorator_startlabel_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][0][start_label]"; ?>" />
						</div>
						<div class="stl_timeline_decorator_optional">
							<label for="<?php echo "stl_timelinedecorator_endlabel_".$band->id."0"; ?>"><?php _e('End Label', 'stl_timeline'); ?></label>
							<input type="text" value="" id="<?php echo "stl_timelinedecorator_endlabel_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][0][end_label]"; ?>" />
						</div>
						<div>
							<label for="<?php echo "stl_timelinedecorator_cssclass_".$band->id."0"; ?>"><?php _e('CSS class', 'stl_timeline'); ?></label>
							<input type="text" value="" id="<?php echo "stl_timelinedecorator_cssclass_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][0][css_class]"; ?>" />
						</div>
						<div>
							<label><?php _e('Color', 'stl_timeline'); ?></label>
							<?php echo WPSimileTimelineAdmin::buildColorpickInput("stl_timeline[bands][$band->id][decorators][0][color]",$band->id,'stl_band'.$band->id.'0_decoratorcolor', '#aaa'); ?>
						</div>
						<div>
							<label for="<?php echo "stl_timelinedecorator_opacity_".$band->id."0"; ?>"><?php _e('Opacity', 'stl_timeline'); ?></label>
							<input type="text" size="3" value="70" id="<?php echo "stl_timelinedecorator_opacity_".$band->id."0"; ?>" name="<?php echo "stl_timeline[bands][$band->id][decorators][0][opacity]"; ?>" />
						</div>
					</div>
