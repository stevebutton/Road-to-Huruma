<?php /*?><?php require( CELTA_LIB . "theme-options-vars.php" ); ?>
<?php */?>

<div id="farright">


	<div id="titlelanding"></div>
            ...
            <!--<ul style="position:absolute;top:350;left:10px;">
<li><a href="javascript:slideToLeft();">Go Left</a></li>
<li><a href="javascript:slideToRight();">Go Right</a></li>
<li><a href="javascript:zoomToToday();">Today</a></li>
<li><a href="javascript:zoomToDays();">Days</a></li>
<li><a href="javascript:zoomToWeeks();">Weeks</a></li>
<li><a href="javascript:zoomToMonths();">Months</a></li>
</ul>-->
...
<!--<div id="gomapswitch"></div>-->
    ...
    <div id="gotoday"></div>
    <div id="gozoom"></div>
    <div id="go2006" style="cursor: auto; float:right; position:absolute; top:0;">2006</div>
    <div id="go2011" style="cursor: auto; float:right; position:absolute; top:20px;">2011</div>
...
<iframe src="http://widget.calameo.com/library/?type=subscription&id=273784&rows=1&sortBy=latestIssue&theme=white&bgColor=&thumbSize=normal&showTitle=true&showShadow=true&showGloss=true&showInfo=&linkTo=embed" width="100%" height="200" frameborder="0"></iframe>
</div>

</div>

</div>
<div id="mapfootermenu">
	<div id="mapfooterlib"></div>
    <div id="mapfooterlibhide"></div>
    <div id="mapfootergoals"></div>
</div>
</div>
<!-- **************END COMBINED TIMELINE+MAP*********************  -->
    ...
    <div id="application">
    <img src="/gfx/timemapref_application.jpg" />
...
<div id="applicationcontent">
 ...
 <div id="flashcontent">
      ...
      <script type="text/javascript">
		...
		so.addVariable("appname", "MediaVoices Application"); // application name to display to the user
		so.addVariable("appurl", "http://www.mediavoicesforchildren.org/mvcair/content_that_moves.air"); // absolute URL (beginning with http or https) of the application ".air" file
		...
		so.addVariable("image", "http://www.mediavoicesforchildren.org/mvcair/DemoImage.jpg"); // URL for an image (JPG, PNG, GIF) or SWF to display in the badge (205px wide, 170px high)
      ...
      <div id="flashdescription">    
    <p><strong>The Road to Huruma</strong> is a desktop application that functions as a gateway to <strong>content</strong> content. </p><p>By installing it on your computer, you open the door to accessing the latest in videos, documents and photography assembled on the site. </p><p>The application talks directly to our servers to present the latest material we have posted. Once installed on your desktop, its yours to view, distribute and use as a reference.</p><p>Click on the <strong>Install Now</strong> button at the left to begin the installation process.</p>
</div>
