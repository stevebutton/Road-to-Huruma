...
function onLoad() {
  ...
  var zoomStepsArray = new Array(
   ...
   var bandInfos = [
	...
	function getMilestone(start, end, color, opacity, label,label2) {
		var rtrn = new Timeline.SpanHighlightDecorator({
						startDate:  start,
						endDate:    end,
						color:      color,
						opacity:    opacity,
						startLabel: ((label) ? label : ""),
						endLabel:   ((label2) ? label2 : ""),
	...
	milestones[0] = [ getMilestone(ladate, tomorrow, "#FF0000", 10),
					  getMilestone(tomorrow.getTime() - (1000 * 3600 * 96), tomorrow.getTime() - (1000 * 3600 * 72), "#FF0000", 15),
					  getMilestone(tomorrow.getTime() + (1000 * 3600 * 72), tomorrow.getTime() + (1000 * 3600 * 192), "#FF0000", 25, "Next Week on crash-box") ];
	milestones[1] = [ getMilestone(ladate, tomorrow, "#FF0000", 10),
					  getMilestone(tomorrow.getTime() + (1000 * 3600 * 72), tomorrow.getTime() + (1000 * 3600 * 384), "#FF0000", 50, "", "End label") ];
	milestones[2] = [ getMilestone(ladate, tomorrow, "#FF0000", 10) ];
	milestones[3] = [ getMilestone(ladate, tomorrow, "#FF0000", 10) ];
	milestones[4] = [ getMilestone(ladate, tomorrow, "#FF0000", 100) ];
	milestones[5] = [ ];
	milestones[6] = [ getMilestone(ladate, tomorrow, "#FF0000", 30) ];
    ...
    while (i < bandInfos.length) {
    	if (bandInfos[i] != null) {
			...
			if (i != 5) {
				bandInfos[i].highlight = true;
				bandInfos[i].decorators = milestones[i];
			}
		}
    ...
    Timeline.loadXML("http://crash-box.fr/index.php?feed=timeline&cat=39", function(xml, url) { eventSource1.loadXML(xml, url); });
...
/*var customIcon = new google.maps.Marker({
   ...
   // set the map to our custom style
    ...
    tm.map.addControls({zoom: 'small', overview: true, scale:true})

args = { pan: true, zoom: 'large' || 'small', overview: true, scale: true, map_type: true, }
});
...
<!-- **************SLIDING BACKGROUND CONTENT*********************-->
    <div id="header">
    <iframe width="100%" height="550" src="http://www.youtube.com/embed/8nBmIetx_t8" frameborder="0" allowfullscreen></iframe>
    <div id="subscription">
    <div id="subscriptiontext">
    <div class="block mid margin_auto"> <p><strong>Crash Box</strong> est une proposition artistique globale dont l'application interactive en ligne est une des apparitions.
Plateforme de distribution évolutive, <strong>Crash Box</strong> permet à ses membres connectés de propager en temps réel l'ensemble des informations et productions liées au développement du projet.</p>
<p>Si vous souhaitez bientôt prendre part à cette œuvre et devenir un des relais de cet essaimage, commencez par vous inscrire gratuitement sur la liste de diffusion du site.</p> 
</div>
    </div>
...
<!--End mc_embed_signup-->
<p><strong>Crash Box</strong> emploie différentes bibliothèques de <strong>Javascript</strong> pour traiter et afficher ses informations. Vous devez avoir <strong>Javascript</strong> disponible en votre navigateur afin de visualiser ce site.

Ce site est en construction, nous le testons via différents navigateurs. Aujourd'hui <strong>1er Mai,</strong> il fonctionne avec:</p>
<p><strong>Macintosh:</strong> Firefox 3.6.17, Safari 5.0, Chrome.<br/>
<strong>Windows:</strong> Internet Explorer 8, Firefox 3.0.19, Chrome.
</p>
</div>
</div>
...
<!--<h2>LE PROJET CRASH BOX</h2>-->
	<!--<div class="contheader">
		...
		<!--<h2>LE PROJET CRASH BOX</h2>-->
		<p><strong>Crash Box</strong> installe le regard au centre d'une démolition par foudroyage intégral, temps fondateur d’une onde de choc. Sa propagation est assurée par un réseau de connexions Internet fédérées par l’application interactive en ligne www.crash-box.fr.
<strong>Crash Box</strong> diffuse en temps réel sur sa plateforme d’essaimage, les images du noyau des explosions. Chaque vidéo est tournée en caméra ultra-rapide (dont la temporalité au millième de seconde est synchrone avec le temps des détonations successives) protégée d’une crash box et placée au cœur du bâti foudroyé.</p>
...
Au final, <strong>Crash Box</strong> donnera lieu à la production d’un court-métrage projeté en salle de cinéma.</p>

<p>Mené en collaboration avec l’entreprise <strong>GINGER-CEBTP DÉMOLITION</strong> comme un laboratoire de recherche, <strong>Crash Box</strong> se structure sous la forme d’un Atelier de l’Euroméditerranée dans le cadre du programme de <strong>Marseille Provence 2013.</strong></p>
<p>Le compte à rebours est réglé au <strong>31/12/2013,</strong> date de clôture contractuelle du projet.</p>
  ...
  <!-- <h2>L’ÉQUIPE DE CRASH BOX</h2>-->
	<div class="contheader2">
		...
		<div class="nav_buttons"> 
			...
			<a id="sublab" class="switcher set2">SUBLAB PRODUCTION</a> 
	...
	<p><strong>GASC DÉMOLITION</strong> conduit les projets de l’artiste Anne-Valérie Gasc qui détermine les stratégies adéquates aux modalités d'ébranlement du réel.
...
Ces propositions interrogent l'utopie de la table rase comme modalité de création.</p>
<p>Récemment, <strong>GASC DÉMOLITION</strong> a procédé à l’étude et l’expérimentation de la démolition par onde sonore de la galerie Hladilnica (194 dB, Centre Culturel de Pekarna, Maribor, Slovénie, 2009), par sabotage hydraulique du Château d’Avignon (La Fuite, Les Saintes-Maries-de-la-Mer, France, 2009), par foudroyage intégral de la VF Galerie (Boum Blocs, Marseille, France, 2008) ou encore par embrasement généralisé éclair de la Maison Rouge (Blockhaus, Paris, France, 2006). Son travail est consultable en ligne sur le site : <a href="http://www.documentsdartistes.org/gasc" target="_blank">www.documentsdartistes.org/gasc</a></p>
<p>
Contact : 
<strong>GASC DÉMOLITION,</strong> Anne-Valérie GASC, La Friche La Belle de Mai, 41 rue Jobin, 13003 Marseille, FRANCE. +33 (0)6 18 39 56 23<br />
<a href="mailto:gascdemolition@gmail.com">gascdemolition@gmail.com</a></p>
...
<p>+33 (0)6 18 39 56 23</p>
 <p><a href="mailto:gascdemolition@gmail.com">gascdemolition@gmail.com</a></p></div>
		<div id="sextant-content" class="switcher-content set2">
		<h2>SEXTANT ET PLUS</h2>
		<p>Association de promotion, de diffusion de l’art contemporain et plateforme de production, Sextant et plus est producteur délégué et coordinateur du projet. L'association est également engagée sur le volet transmission de la proposition artistique.</p>
...
<p><a href="http://www.cebtpdemolition.com" target="_blank">www.cebtpdemolition.com</a></p>
		...
		<p>Laboratoire de création audiovisuelle dont la mission rassemble la production, la conception technique et la réalisation des films en caméras ultra-rapides ainsi que l’accompagnement de la production des films virtuels des démolitions.</p>
...
<div class="block3 mid margin_auto">
	<div class="contheader3">
		<div class="nav_buttons2"> 
			...
			<a id="footer" class="switcher set3">Au Sujet du site</a>		</div> 
	</div>
		...
		<strong>CAPITALE EUROPÉENNE DE LA CULTURE</strong>
...
Marseille-Provence donne rendez-vous au monde en 2013 pour une année Capitale.		</div>
		<div id="footer-content" class="switcher-content set3 show">
		<h2>AU SUJET DU SITE</h2>
		<p>Le projet <strong>Crash Box</strong> emprunte du code et des librairies de plusieurs projets, mais plus particulierement
du projet <strong><a href="http://code.google.com/p/timemap/" target="_blank">Timemap</a></strong> par Nick Rabinowitz.</p>

<p>Le projet <strong>Timemap</strong> est une extension du <strong><a href="http://www.simile-widgets.org/timeline/" target="_blank">Simile Timeline Project</a>.</strong></p>

<p>Le concept et le design du site ont ete assures par <a href="mailto:contact@stevebutton.net">Steve Button | Designannexe</a><br/>et Anne-Valérie Gasc.</p><p>Programmation additionnelle par Arnaud Rouyer.</p>		</div>
  ...
  <div id="footerright"><a href="http://www.marseille-provence2013.fr/" target="_blank"><img src="gfx/2013.png" alt="" /></a><a href="http://www.cebtpdemolition.com/" target="_blank"><img src="gfx/ginger.png" alt="" /></a></div> 
</div>       
<!--  **************SLIDING FOOTER+CREDITS*********************    -->    
    
   <script type="text/javascript">
$( "#enter" ).click(function full_screen(){
window.moveTo(0,0)
