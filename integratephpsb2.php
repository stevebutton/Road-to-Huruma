...
<p>Si vous souhaitez bientôt prendre part à cette œuvre et devenir un des relais de cet essaimage, commencez par vous inscrire gratuitement sur la liste de diffusion du site.</p> </div>
    </div>
  ...
  <!-- <h2>L’ÉQUIPE DE CRASH BOX</h2>-->
	<div class="contheader2">
		...
		<div class="nav_buttons"> 
			...
			<a id="dannexe" class="switcher set2">DESIGNANNEXE</a>		</div> 
	</div>
...
<noscript>
	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="337" height="40" id="crashboxsocial" align="middle">
	<param name="allowScriptAccess" value="sameDomain" />
	<param name="allowFullScreen" value="false" />
    <param name="wmode" value="transparent" />
	<param name="movie" value="gfx/crashboxsocial.swf" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />	<embed src="gfx/crashboxsocial.swf" quality="high" bgcolor="#ffffff" width="337" height="40" name="crashboxsocial" align="middle" wmode="transparent" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
	</object>
</noscript>-->
...
<p>Le concept et le design du site ont ete assures par <a href="mailto:contact@stevebutton.net">Steve Button | Designannexe</a> et Anne-Valérie Gasc.</p><p>Programmation additionnelle par Arnaud Rouyer.</p>		</div>
  ...
  <div id="footerright">
  <div id ="subscribebt"><img src="gfx/subscribebt.png" alt="" />
