...
<!-- **************SLIDING BACKGROUND CONTENT*********************-->
    ...
    <div class="block mid margin_auto"> <blockquote>Suspendisse semper, magna eu blandit pellentesque, elit purus tristique orci, sit amet congue lectus purus ut nisi. Curabitur mollis purus sed purus commodo vitae malesuada sem viverra? Nunc mattis cursus elit, eget accumsan diam semper a.
</blockquote> 
</div>
    </div>
    <div id="subscriptionform">
    <p>Suspendisse semper, magna eu blandit pellentesque, elit purus tristique orci, sit amet congue lectus purus ut nisi.
</p>
...
<noscript>
	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="850" height="120" id="Countdown_final" align="middle">
	<param name="allowScriptAccess" value="sameDomain" />
	<param name="allowFullScreen" value="false" />
	<param name="movie" value="slidingsite/Countdown_final.swf" /><param name="quality" value="high" /><param name="wmode" value="transparent" />	<embed src="slidingsite/Countdown_final.swf" quality="high" bgcolor="#ffffff" width="850" height="120" name="Countdown_final" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
	</object>
</noscript>
</div>
       			<div id="controls">
...
$( "#footerplus" ).click(function(){
 ...
 /* $( "#footer" ).animate({ top: "440px" }, 500 )*/
  $( "#footer" ).animate({ height: "385px" }, 500 )
