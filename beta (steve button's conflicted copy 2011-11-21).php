...
<?php include "http//sameheart.designannexe.com/timemap.2.0/examples/user.php" ?>
...
function onLoad() {
  ...
  var zoomStepsArray = new Array(
   ...
   var bandInfos = [
    ...
    Timeline.loadXML("http://sameheart.designannexe.com/index.php?feed=timeline&cat=3", function(xml, url) { eventSource.loadXML(xml, url); });
    ...
    Timeline.loadXML("http://sameheart.designannexe.com/index.php?feed=timeline&cat=5", function(xml, url) { eventSource2.loadXML(xml, url); });
    Timeline.loadXML("http://sameheart.designannexe.com/index.php?feed=timeline&cat=6", function(xml, url) { eventSource3.loadXML(xml, url); });
